...
//Fecha de entrega: 07 septiembre del 2025
#include<iostream>
#include <GL/glew.h>
...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 5 Gabriela Aquino", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelTemp2 = modelTemp3 = modelTemp = model = glm::translate(model, glm::vec3(0.25f, 0.0f, 0.0f));
		...
		//Model Dedo2 A
		model = glm::translate(modelTemp3, glm::vec3(0.25f, 0.35f, 0.100f));
